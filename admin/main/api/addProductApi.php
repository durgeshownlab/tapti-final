...
$sql="insert into products (product_name, product_image, product_price, product_desc, sub_category_id, base_price, quantity) values ('{$_POST['product_name']}', '{$new_file_name}', {$_POST['product_price']}, '{$_POST['product_desc']}', {$_POST['product_sub_category']}, {$_POST['product_base_price']}, {$_POST['product_quantity']})";

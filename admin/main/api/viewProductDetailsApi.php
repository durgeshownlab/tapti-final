<?php   
    ...
    $sql="select products.product_name as name, products.product_image as image, products.product_price as price, products.base_price as base_price, products.quantity as quantity, products.product_desc as description, category.name as category, sub_category.name as sub_category from products join sub_category on sub_category.sub_category_id=products.sub_category_id join category on sub_category.category_id=category.id where products.product_id={$_POST['product_id']} and products.is_deleted=0";
            ...
            <div class="modal-body">
                <div class="d-flex">
                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            <b class="col">Base Price: </b>
                            <p class="col">&#8377; '.number_format($row['base_price']).'</p>
                        </div>
                        <div class="row">
                            <b class="col">Main Price: </b>

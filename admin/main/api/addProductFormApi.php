        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col form-group">
                    ...
                    <input type="number" class="form-control input-flat" placeholder="Base Price" name="product-base-price" id="product-base-price" required>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col form-group">
                    ...
                    <input type="number" class="form-control input-flat" placeholder="Main Price" name="product-price" id="product-price" required>
                </div>

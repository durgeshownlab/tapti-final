...
$sql="select products.product_name as name, products.product_image as image, products.product_price as price, products.base_price as base_price, products.quantity as quantity, products.product_desc as description, category.id as category_id, category.name as category, sub_category.sub_category_id as sub_category_id, sub_category.name as sub_category from products join sub_category on sub_category.sub_category_id=products.sub_category_id join category on sub_category.category_id=category.id where products.product_id={$_POST['product_id']} and products.is_deleted=0";
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col form-group">
                    ...
                    <input type="number" class="form-control input-flat" placeholder="Base Price" name="product-base-price" id="product-base-price" value="'.$row['base_price'].'" required>
                </div>
            </div>

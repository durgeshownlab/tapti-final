...
if(isset($_FILES['product_main_image']) && $_FILES['product_main_image']['error'] === UPLOAD_ERR_OK && !isset($_FILES['product_other_image']))
{
    ...
    if ($file_error === UPLOAD_ERR_OK) 
    {
        ...
        if (move_uploaded_file($file_tmp_name, $destination)) 
        {
            ...
            $sql="update products set product_name='{$_POST['product_name']}', product_image='{$new_file_name}', product_price={$_POST['product_price']}, product_desc='{$product_desc}', sub_category_id={$_POST['product_sub_category']}, base_price={$_POST['product_base_price']}, quantity={$_POST['product_quantity']} where product_id={$_POST['product_id']} and is_deleted=0";
...
else if(isset($_FILES['product_other_image']) && is_array($_FILES["product_other_image"]) && !isset($_FILES['product_main_image']))
{
    ...
    {
        $product_desc = mysqli_real_escape_string($conn, $_POST['product_desc']);
        $sql="update products set product_name='{$_POST['product_name']}', product_price={$_POST['product_price']}, product_desc='{$product_desc}', sub_category_id={$_POST['product_sub_category']}, base_price={$_POST['product_base_price']}, quantity={$_POST['product_quantity']} where product_id={$_POST['product_id']} and is_deleted=0";

                ...
                <div class="row">
                    <div class="col-lg-8 col-md-12">
                        ...
                        <div class="services-details-desc">
                            <h3>We Ensure To Provide 100% Organic Food</h3>
                            ...
                            <h3>Why we Provide Vegetables and Food</h3>
                            ...
                            <div class="services-details-features">
                                <div class="features-text">
                                    <h4><i class='bx bx-check'></i> How can take our food</h4>
                                    <p>No fake products and services. The customer is king their lives and needs are the inspiration.</p>
                                </div>
                                <div class="features-text">
                                    <h4><i class='bx bx-check'></i> Why we success organic farming</h4>
                                    <p>No fake products and services. The customer is king their lives and needs are the inspiration.</p>
                                </div>
                                <div class="features-text">
                                    <h4><i class='bx bx-check'></i> History of our festival vegetables</h4>
                                    <p>No fake products and services. The customer is king their lives and needs are the inspiration.</p>
                                </div>
                                <div class="features-text">
                                    <h4><i class='bx bx-check'></i> Natural Fresh Tomato</h4>
                                    <p>No fake products and services. The customer is king their lives and needs are the inspiration.</p>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="services-details-information">
                            <ul class="services-list">
                                <li><a href="#" class="active">Organic Vegetables</a></li>
                                <li><a href="#">Full Of Vitamins</a></li>
                                <li><a href="#">Fresh Milk & Meat</a></li>
                            ...
                            <div class="services-contact-info">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <span>Email:</span>
                                        <a href="mailto:hello@E-Shop Baba.com">hello@E-Shop Baba.com</a>
                                    </li>
                                </ul>
                            </div>
                        </div>

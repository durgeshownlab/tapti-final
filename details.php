                                                        ...
                                                        <div class="col-lg-12 col-md-12">
                                                            <div class="form-group">
                                                                <textarea name="review-body" id="review-body" cols="30"
                                                                    rows="7" placeholder="Write your comments here"
                ...
                <div class="related-shop">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="top-products-item">
                                <div class="products-image">
                                    <a href="shop-details.php"><img src="assets/img/top-products/top-products-1.jpg"
                                            alt="image"></a>

                                    <ul class="products-action">
                                        <li>
                                            <a href="cart.php" data-tooltip="tooltip" data-placement="top"
                                ...
                                <div class="products-content">
                                    <h3>
                                        <a href="shop-details.php">Darling Oranges</a>
                                    </h3>
                                    <div class="price">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="top-products-item">
                                <div class="products-image">
                                    <a href="shop-details.php"><img src="assets/img/top-products/top-products-2.jpg"
                                            alt="image"></a>
                                ...
                                <div class="products-content">
                                    <h3>
                                        <a href="shop-details.php">Strawberry</a>
                                    </h3>
                                    <div class="price">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="top-products-item">
                                <div class="products-image">
                                    <a href="shop-details.php"><img src="assets/img/top-products/top-products-3.jpg"
                                            alt="image"></a>
                                ...
                                <div class="products-content">
                                    <h3>
                                        <a href="shop-details.php">Cabbage</a>
                                    </h3>
                                    <div class="price">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="top-products-item">
                                <div class="products-image">
                                    <a href="shop-details.php"><img src="assets/img/top-products/top-products-4.jpg"
                                            alt="image"></a>
                                ...
                                <div class="products-content">
                                    <h3>
                                        <a href="shop-details.php">Nectarine</a>
                                    </h3>
                                    <div class="price">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="featured-products-item">
                    <div class="products-image">
                        <a href="shop-details.php"><img src="assets/img/featured-products/featured-products-1.jpg"
                                alt="image"></a>

                        <ul class="products-action">
                            <li>
                                <a href="cart.php" data-tooltip="tooltip" data-placement="top" title="Add to Cart"><i
                    ...
                    <div class="products-content">
                        <h3>
                            <a href="shop-details.php">Bean</a>
                        </h3>
                        <div class="price">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="featured-products-item">
                    <div class="products-image">
                        <a href="shop-details.php"><img src="assets/img/featured-products/featured-products-2.jpg"
                                alt="image"></a>
                    ...
                    <div class="products-content">
                        <h3>
                            <a href="shop-details.php">Pomegranate</a>
                        </h3>
                        <div class="price">
                            <span class="new-price">$30.00</span>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="featured-products-item">
                    <div class="products-image">
                        <a href="shop-details.php"><img src="assets/img/featured-products/featured-products-3.jpg"
                                alt="image"></a>
                    ...
                    <div class="products-content">
                        <h3>
                            <a href="shop-details.php">Avocado</a>
                        </h3>
                        <div class="price">
                            <span class="new-price">$40.00</span>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="featured-products-item">
                    <div class="products-image">
                        <a href="shop-details.php"><img src="assets/img/featured-products/featured-products-4.jpg"
                                alt="image"></a>
                    ...
                    <div class="products-content">
                        <h3>
                            <a href="shop-details.php">Capsicum</a>
                        </h3>
                        <div class="price">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="featured-products-item">
                    <div class="products-image">
                        <a href="shop-details.php"><img src="assets/img/featured-products/featured-products-5.jpg"
                                alt="image"></a>
                    ...
                    <div class="products-content">
                        <h3>
                            <a href="shop-details.php">WaterMelon</a>
                        </h3>
                        <div class="price">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="featured-products-item">
                    <div class="products-image">
                        <a href="shop-details.php"><img src="assets/img/featured-products/featured-products-6.jpg"
                                alt="image"></a>
                    ...
                    <div class="products-content">
                        <h3>
                            <a href="shop-details.php">Crab Apples</a>
                        </h3>
                        <div class="price">
                            <span class="new-price">$45.00</span>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="featured-products-item">
                    <div class="products-image">
                        <a href="shop-details.php"><img src="assets/img/featured-products/featured-products-7.jpg"
                                alt="image"></a>
                    ...
                    <div class="products-content">
                        <h3>
                            <a href="shop-details.php">Pea-nut</a>
                        </h3>
                        <div class="price">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="featured-products-item">
                    <div class="products-image">
                        <a href="shop-details.php"><img src="assets/img/featured-products/featured-products-8.jpg"
                                alt="image"></a>
                    ...
                    <div class="products-content">
                        <h3>
                            <a href="shop-details.php">Mint</a>
                        </h3>
                        <div class="price">
